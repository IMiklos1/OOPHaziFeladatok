...
namespace Myproducts
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(product2.ToString()); // a tostring az a bread osztalyon belul definialtkent mukodik
            //Console.WriteLine(product2.Quantity); a getter metodus igy nem mukodik
